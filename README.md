...
| `VECTOR_STORE_MTLS_CA_CERT_PATH`           | When set mTLS API endpoint is enabled. Path to the CA cert to verify client. Requires `VECTOR_STORE_TLS_CERT_PATH` and `VECTOR_STORE_TLS_KEY_PATH`. |                          |
