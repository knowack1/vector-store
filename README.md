...
| `VECTOR_STORE_MTLS_URI`                    | Bind address and port for the mTLS endpoint. Requires TLS cert and key.                                                  | `127.0.0.1:6081`           |
| `VECTOR_STORE_MTLS_CA_CERT_PATH`           | Path to CA certificate used to verify client certificates. Setting this activates the mTLS endpoint.                     |                            |
